...
true_state = state.State(planets=[{"m":1.2e-3, "a":0.66, "h":0.218, "k":0.015, "l":0.3},{"m":2.1e-3, "a":1.08, "h":0.16, "k":0.02, "l":2.2}])
#true_state = state.State(planets=[{"m":1.2e-3, "a":0.22, "h":0.218, "k":0.015, "l":0.3}, {"m":2.1e-3, "a":0.361, "h":0.16, "k":0.02, "l":2.2}])
obs = observations.FakeObservation(true_state, Npoints=200, error=1.5e-4, errorVar=2.5e-5, tmax=(100.))
